console.log("hi from cli : command line interface :D ");
 const fs = require("fs"); // to get the file system library 
 
 //fs.writeFileSync("studentsGrades.txt","[]");  // to create the file 

//  to put the [[studentId(autoincrement),studentName,studentGrade]]
...
// to edit the grade of the student by id 
